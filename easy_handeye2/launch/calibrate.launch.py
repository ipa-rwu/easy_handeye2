...
from easy_handeye2.common_launch import arg_calibration_type, arg_tracking_base_frame, arg_tracking_marker_frame, arg_robot_base_frame, \
    arg_robot_effector_frame, arg_move_group_namespace, arg_move_group


def generate_launch_description():
    arg_namespace_prefix = DeclareLaunchArgument('namespace_prefix', default_value='easy_handeye2')
    arg_name = DeclareLaunchArgument('name', default_value='')
